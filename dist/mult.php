        ...
        <div class="model">                       
            ...
            <div class="descr">
                    ...
                    <div class="settings_number">                                            
                        ...
                        <p><input name="number" type="radio" value="2" class="dis" >-умножение на 2</p>                         
                        <p><input name="number" type="radio" value="3" class="dis" >-умножение на  3</p>                         
                        <p><input name="number" type="radio" value="4" class="dis" >-умножение на  4</p>                         
                        <p><input name="number" type="radio" value="5" class="dis" >-умножение на  5</p>                         
                        <p><input name="number" type="radio" value="6" class="dis" >-умножение на  6</p>                         
                        <p><input name="number" type="radio" value="7" class="dis" >-умножение на  7</p>                         
                        <p><input name="number" type="radio" value="8" class="dis" >-умножение на  8</p>                         
                        <p><input name="number" type="radio" value="9" class="dis" >-умножение на  9</p>                      
                    </div>
